...
showSMSVerifyDialog(
  ...
  showDialog<void>(
      ...
      builder: (_) => SMSVerifyDialog(okcb: okcb, canclecb: canclecb)
  );
...
//    });
              ...
              EditableText(
                ...
                onChanged: (v) {
                  ...
                  if (v.length == _codeList.length) {
                    // FToast.toast(context, msg:'验证码：${_controller.text}');
                    Get.back();
  ...
  Widget _buildInputWidget(int p, Color textColor) {
    return Container(
        ...
        alignment: Alignment.center,
        decoration: BoxDecoration(
          border: Border.all(width: 0.6, color: _codeList[p].isNotEmpty ? textColor : Colors.grey),
          borderRadius: BorderRadius.circular(4.0),
        ),
        child: Text(_codeList[p], style: const TextStyle(fontSize: 18),)
    );
  }
}
