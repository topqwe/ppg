...
import '../api/models/city_entity.dart';
...
class _CitySelectPageState extends State<CitySelectPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: DefaultAppBar(titleStr: '城市'.tr,),
      body: SafeArea(
        child: AzListView(
          data: _cityList,
          ...
          indexBarOptions: IndexBarOptions(
            ...
            downTextStyle:  const TextStyle(fontSize: 12.0, color: Colors.black),
          ),
        ),
      ),
    );
