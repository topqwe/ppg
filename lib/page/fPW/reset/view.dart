...
class ResetFPWPage extends StatelessWidget {
  final logic = Get.put(ResetFPWLogic());
                ...
                child: SingleChildScrollView(
                    child: Container(
                        margin: const EdgeInsets.only(
                            top: 1, bottom: 15, right: 15, left: 15),
                        child: Column(
